...
<!-- Barra de navegación -->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="directorMenu.jsp"><i class="fas fa-home mr-1"></i> Inicio</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="welcome-banner">
            <h2><i class="fas fa-graduation-cap mr-2"></i>Sistema de Gestión Académica de anteproyectos - Dirección</h2>
            <p class="mb-0">Bienvenido al portal de Dirección de las Unidades Tecnológicas de Santander.</p>
            <p>${sessionScope.nombreDir} ${sessionScope.apellidosDir}, CC: ${sessionScope.identificacionDirector}</p> 
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Gestion de anteproyectos de grado, correciones y califica el anteproyecto de grado de tus estudiantes asiganados.</p>
                        <a href="Anteproyecto/mostrarAnteproyecto.jsp" class="btn btn-primary"><i class="fas fa-clipboard-list mr-2"></i>Acceder</a>
                    </div>
                </div>
            </div>
            ...
            <!-- Card 3: Formatos de anteProyecto de grado -->
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-header">
