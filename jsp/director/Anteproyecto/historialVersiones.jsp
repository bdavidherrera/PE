...
<title>Historial-Versiones-Director</title>
</head>
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="info-coordinador">
                <p><strong>Director:</strong> ${sessionScope.nombreDir} ${sessionScope.apellidosDir}</p>
                <p><strong>CC:</strong> ${sessionScope.identificacionDirector}</p>
            </div>
            ...
            <form id="formObservacion" method="POST">
                ...
                <input type="hidden" name="autor_id" value="${sessionScope.identificacionDirector}" />
                <input type="hidden" name="autor_rol" value="Director" />
