                ...
                <div class="row">
                    <div class="col-12">
                        <div id="tabla-header" class="mb-4">
                            ...
                            <p class="text-muted mt-3">Puedes ver los Anteproyectos de tus estudiantes asignados y calificarlos</p>
                        </div>
                        ...
                        <div id="tabla-contenido" class="mt-4">
                            <div class="table-responsive">
                                <table class="table table-custom table-hover">
                                    ...
                                    <tbody>
                                        <sql:query var="result" scope="request" dataSource="${anteproyecto}">
                                            SELECT * FROM anteproyecto WHERE identificaciondir=${sessionScope.identificacionDirector};
                                        </sql:query>
                                ...
                                <div class="text-center mt-4">
                                        <a href="../directorMenu.jsp" class="btn new-btn">
