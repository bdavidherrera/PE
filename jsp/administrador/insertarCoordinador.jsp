...
<c:if test="${not empty param.noidentificacionc}">
    ...
    <c:choose>
        <c:when test="${verificacion.rowCount == 0}">
            <sql:update var="result" dataSource="${anteproyecto}">
                INSERT INTO coordinador (noidentificacionc, nombre, apellidos, password, fk_id_rolc)
                VALUES (?, ?, ?, ?, 2)
                <sql:param value="${param.noidentificacionc}" />
...
<title>InsertarCoordinador</title>
</head>
<body>
        ...
        <div class="col-lg-6 col-md-8">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5">
                    <h3 class="text-center mb-4 text-primary">Registro de Coordinador</h3>
                    <form method="post">
                        <div class="mb-3">
                            <label for="noidentificacionc" class="form-label">Identificación</label>
                            <input type="number" class="form-control" name="noidentificacionc" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary w-100" value="1" name="evaluar">Registrar Coordinador</button>
                        </div>
                    </form>
                            <div class="button-group">
                            <a href="mostrarCoordinador.jsp" class="btn btn-primary w-100">Mostrar Coordinador</a>
                            </div>
                    ...
                    <c:if test="${param.evaluar=='1' && (not empty param.noidentificacionc && registroDuplicado)}">
                            <div class="alert alert-danger alert-dismissible fade show mt-3">
                                <i class="fas fa-exclamation-circle mr-2"></i> Datos en uso. Ingresar otro numero de identificación y contraseña.
                                <button type="button" class="close" data-dismiss="alert" aria-label="Cerrar">
                                        <span aria-hidden="true">&times;</span>
