...
<title>MostrarEstudiantes</title>
</head>
<body>
                ...
                <div class="row">
                    <div class="col-12.8">
                        <div id="tabla-header" class="mb-4">
                            <h2 class="title-with-underline">Mostrar Estudiantes</h2>
                            <p class="text-muted mt-3">Actualización y elimininación de Estudiantes</p>
                        </div>
                        ...
                        <div id="tabla-contenido" class="mt-4">
                            <div class="table-responsive">
                                <table class="table table-custom table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Correo</th>
                                            <th>Contraseña</th>
                                            <th>rol estudiante = 6</th>
                                            <th class="text-center">Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <sql:query var="result" scope="request" dataSource="${anteproyecto}">
                                            SELECT * FROM estudianteuts WHERE noidentificacion > 0;
                                        </sql:query>
                                        ...
                                        <c:forEach var="fila" items="${result.rows}">
                                            <tr>
                                                <td><c:out value="${fila.noidentificacion}" /></td>
                                                ...
                                                <td><c:out value="${fila.fk_id_rol}" /></td>
                                                <td class="text-center">
                                                    <a href="updateEstudiante.jsp?id=<c:out value='${fila.noidentificacion}' />" class="btn action-btn edit-btn">
                                                        <i class="fas fa-edit"></i> Editar
                                                    </a>
                                                    <a href="vorrarEstudiante.jsp?id=<c:out value='${fila.noidentificacion}' />" class="btn action-btn delete-btn">
                                ...
                                <div class="text-center mt-4">
                                        <a href="insertarEstudiante.jsp" class="btn new-btn">
