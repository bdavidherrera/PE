...
<head>
<meta charset="UTF-8">
<title>Historial-Versiones-Evaluador</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="info-coordinador">
                <p><strong>Director:</strong> ${sessionScope.nombreEva} ${sessionScope.apellidosEva}</p>
                <p><strong>CC:</strong> ${sessionScope.identificacionpEva}</p>
            </div>
            ...
            <form id="formObservacion" method="POST">
                ...
                <input type="hidden" name="autor_id" value="${sessionScope.identificacionpEva}" />
                <input type="hidden" name="autor_rol" value="Evaluador" />
