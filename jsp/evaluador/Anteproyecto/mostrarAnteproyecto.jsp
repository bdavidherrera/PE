            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="../directorMenu.jsp"><i class="fas fa-home mr-1"></i> Regresar al menu </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-12">
                        <div id="tabla-header" class="mb-4">
                            ...
                            <p class="text-muted mt-3">Puedes ver los Anteproyectos de tus estudiantes asignados</p>
                        </div>
                        ...
                        <div id="tabla-contenido" class="mt-4">
                            <div class="table-responsive">
                                <table class="table table-custom table-hover">
                                    ...
                                    <tbody>
                                        <sql:query var="result" scope="request" dataSource="${anteproyecto}">
                                            SELECT * FROM anteproyecto WHERE fk_id_profesor=${sessionScope.identificacionpEva} AND calificaciondir= 'aprobado';
                                        </sql:query>
                                        ...
                                        <c:forEach var="fila" items="${result.rows}">
                                            ...
                                            <c:if test="${fila.radicaante == 'Sin adjuntar'}">
                                                <td class="text-center">
                                                    <a href="actualizarCalificacion.jsp?id=<c:out value='${fila.id}' /> " 
                                                    class="btn action-btn edit-btn">
                                                        <i class="fas fa-edit"></i> Ingresar tu calificación
                                                    </a>
                                                </td>
                                            </c:if>
                                            </tr>
                                ...
                                <div class="text-center mt-4">
                                        <a href="../evaluadorMenu.jsp" class="btn new-btn">
