...
<!-- Barra de navegación -->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="evaluadorMenu.jsp"><i class="fas fa-home mr-1"></i> Inicio</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="welcome-banner">
            <h2><i class="fas fa-graduation-cap mr-2"></i>Sistema de Gestión Académica de anteproyectos - Evaluador</h2>
            <p class="mb-0">Bienvenido al portal del evaluador de las Unidades Tecnológicas de Santander.</p>
            <p>${sessionScope.nombreEva} ${sessionScope.apellidosEva}, CC: ${sessionScope.identificacionpEva}</p> 
        </div>
