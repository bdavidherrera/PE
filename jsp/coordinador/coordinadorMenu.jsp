...
<!-- Barra de navegación -->
    ...
    <div class="container">
        <div class="welcome-banner">
            ...
            <p class="mb-0">Bienvenido al portal de Coordinación de las Unidades Tecnológicas de Santander.</p>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Gestione los anteproyectos de grado, asigne directores y evaluadores, crea la idea o propuesta para ser seleccionada y evalua finalmente la propuesta.</p>
                        <a href="AnteProyectoCoor.jsp" class="btn btn-primary"><i class="fas fa-clipboard-list mr-2"></i>Acceder</a>
                    </div>
                </div>
            </div>
